# Mustang Animated Key


![Mustang Logo](https://github.com/MehrdadHosseinNejad74/animated-button/blob/master/assets/images/mustang.png)

This app includes an animated button. When you click on this button, it acts like it pressed, then an animated blue border is displayed.
